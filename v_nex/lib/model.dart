...
class ExampleModel {
  static const List<PickerModel> Standards = <PickerModel>[
    ...
    PickerModel('IX Standard', code: 'IX'),
  ];
  ...
  static const List<PickerModel> Subject = <PickerModel>[
    ...
    PickerModel('Biology', code: 'B'),
    PickerModel('ComputerScience', code: 'CSC'),
    PickerModel('English', code: 'E'),
    PickerModel('Tamil', code: 'T'),
    PickerModel('French', code: 'F'),    
    PickerModel('General', code: 'G')
  ];
  PickerModel selectedSubject = Subject[0];
